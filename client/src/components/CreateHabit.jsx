...
const CreateHabit = ({ isOpen, onClose, onHabitCreated, preselectedCategory = 'custom', lockedCategory = null }) => {
    ...
    const [screenTimeGoal, setScreenTimeGoal] = useState(120); // default 2 hours
            ...
            <div className="fixed inset-0 bg-black bg-opacity-50 flex items-center justify-center z-50">
                ...
                >
                    ...
                    <form onSubmit={handleSubmit} className="space-y-4">
                        ...
                        {/* Only show category selection if not locked */}
                        {!lockedCategory && (
                            <div>
